...
var introfingureX = 630, introfingureY = 290;
var introQuesArr = [];
var introChoiceArr = [];
var introbtnX = [465, 598, 731];
var introbtnY = [480, 281, 480];
function commongameintro() {
    ...
    for (i = 0; i < 3; i++) {
        ...
        introChoiceArr[i].x = introbtnX[i] + 50;
        introChoiceArr[i].y = introbtnY[i] + 50;
...
function ansTween1() {
    createjs.Tween.get(introChoiceArr[1]).wait(200).to({ scaleX: 1, scaleY: 1 }, 500).to({ scaleX: 1.1, scaleY: 1.1 }, 500)
        .to({ scaleX: 1, scaleY: 1 }, 500).to({ scaleX: 1.1, scaleY: 1.1 }, 500)
        .to({ scaleX: 1, scaleY: 1 }, 500).wait(500).call(handleComplete5_1);
}
