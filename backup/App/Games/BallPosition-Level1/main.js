...
var btnX = [465, 598, 731];
var btnY = [480, 281, 480];
...
function init() {
     ...
     */
    assetsPath = "assets/";
    gameAssetsPath = "BallPosition-Level1/";
    soundpath = "FA/"

    var success = createManifest();
    if (success == 1) {
        manifest.push(
            { id: "questionText", src: questionTextPath + "BallPosition-Level1-QT.png" },
            { id: "questionText1", src: questionTextPath + "BallPosition-Level1-QT1.png" },
...
function AddListenerFn() {
    ...
    for (i = 0; i < 3; i++) {
        ...
        choiceArr[rand[2]].gotoAndStop(qno1[rand[2]]);
        choiceArr[i].name = i;
    }
    ans1 = rand[2];
