                                    ...
                                    if (error3) {
                                        ...
                                        if (results3.rows[0].count > 0) {
                                            ...
                                            client.query('SELECT count(*) FROM public.skillangels_skillkitgames_cylce_entry where (select getserverdate())<=\
                                                ...
                                                [uid, 1, year_status], (error5, results5) => {
                                                    if (error5) {
                                                        done();
                                                        ...
                                                        if (results5.rows[0].count > 0) {
                                                            ...
                                                            client.query('SELECT count(*) FROM public.skillangels_games_cylce_entry where (select getserverdate())=\
                                                                            ...
                                                                            event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                                                            and  user_id =$1 and    event_id =$2 and current_year_status =$3',
                                                                [uid, 1, year_status], (error6, results6) => {
                                                                    if (error6) {
                                                                        done();
                                                                        ...
                                                                        if (results6.rows[0].count > 0) {
                                                                            ...
                                                                            event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                                                            and  user_id =$1 and    event_id =$2 and current_year_status =$3',
                                                                                [uid, 1, year_status], (error12, results12) => {
                                                                                    if (error12) {
                                                                                        done();
                                            ...
                                            event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                            and  user_id =$1 and    event_id =$2 and current_year_status =$3 ',
                                                [uid, 1, year_status], (error10, results10) => {
                                                    if (error10) {
                                                        done();
                                                        ...
                                                        if (results10.rows.length > 0) {
                                                            ...
                                                            if (results10.rows[0].status == 1) {
                                                                ...
                                                                event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                                                and  user_id =$1 and    event_id =$2 and current_year_status =$3',
                                                                    [uid, 1, year_status], (error7, results7) => {
                                                                        if (error7) {
                                                                            done();
                                                                            ...
                                                                            if (results7.rows[0].count > 0) {
                                                                                ...
                                                                                event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                                                                and  user_id =$1 and    event_id =$2 and current_year_status =$3',
                                                                                    [uid, 1, year_status], (error8, results8) => {
                                                                                        if (error8) {
                                                                                            done();
                                                                                            ...
                                                                                            if (results8.rows[0].count > 0) {
                                                                                                ...
                                                                                                event_id =$2  and current_year_status =$3 order by actual_start_date desc LIMIT 1)) \
                                                                                                and  user_id =$1 and    event_id =$2 and current_year_status =$3',
                                                                                                    [uid, 1, year_status], (error9, results9) => {
                                                                                                        if (error9) {
                                                                                                            done();
                                                                                                            response.status(200).json({ status: 'Failure', code: 'SA434', message: 'Skillangels_games_cylce_entry status error on checkskilllist' });
                                                                                                        }
                                    ...
                                    (error, results) => {
                                        if (error) {
                                            ...
                                            if (results.rows.length > 0) {
                                                ...
                                                if (skillkitcyclecnt == gamecyclecnt || (Number(results.rows[0].gamecyclecnt) == 16 && skid == 2 && skillkitcyclecnt == 8)) {
    ...
    try {
        pool.connect((err, client, done) => {
            if (err) {
                ...
                client.query('select getserverdate()', (error, results) => {
                    if (error) {
                        console.log("error")
                        done();
                                            ...
                                            (error, results) => {
                                                if (error) {
                                                    ...
                                                    if (results.rows.length > 0) {
                                                        ...
                                                        if (orgskillcyclecnt == orggamescyclecnt || (Number(results.rows[0].orggamescyclecnt) == 16 && skid == 2 && orgskillcyclecnt == 8)) {
                                                                ...
                                                                on skillangels_users.branch_id = skillangels_schoolgrade.branch_id and skillangels_schoolgradesections.gradeid = skillangels_schoolgrade.id',
                                                                    [uid], (error1, results1) => {
                                                                        if (error1) {
                                                                            ...
                                                                            response.status(200).json({ status: 'Success', code: 'SA000', result: results.rows, medianval: results1.rows, skill_id, message: 'Skillkit status data retrieval successful' });
                                                                        }
                                                                    })
                                                            }
                                                        })
